...
function ensureThemeStyles() {
  ...
  let style = document.getElementById('m115-v2-theme-styles') as HTMLStyleElement | null
  if (!style) {
  ...
  controlsRow.innerHTML = `
    ...
    <div class="m115-v2-left-cluster">
      ...
      <div class="m115-v2-volume-cluster">
        <button class="m115-v2-ctrl-icon-btn m115-vol-btn" title="静音 / 取消静音 ( M )">
          ${Icons.Volume2()}
        </button>
    ...
    <div class="m115-v2-right-cluster">
      ...
      <button class="m115-v2-ctrl-icon-btn m115-rotate-btn" title="画面旋转 90° ( R )">
        ${Icons.RotateCw()}
      </button>
