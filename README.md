...
- 本项目由 **老魔** 维护，基于 **[GPL-3.0](LICENSE)** 协议开源，欢迎自由使用、修改与分享，也欢迎基于它做复刻。
- **名称与图标**：项目名称「115m」、Logo 与图标是它的身份标识，不在开源授权范围内。做复刻或二次发布时，麻烦换一个自己的名称与图标，也不要让人误以为与官方有关。
- **标明出处**：复刻与再分发时，欢迎顺手标明出处，保留本项目的版权声明与 GPL-3.0 协议，并附上原始仓库地址。
- **官方来源**：本项目仅在本仓库维护发布 —— <https://github.com/qh775885/115m>。其他商店或网站上的「115m」版本均为第三方版本。
- 完整说明见 **[NOTICE](NOTICE)**。
